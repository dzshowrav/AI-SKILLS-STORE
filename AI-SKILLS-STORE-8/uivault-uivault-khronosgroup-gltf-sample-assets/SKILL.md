...
description: UI Vault resource — Free 3D Models for Scroll Effects. https://github.com/KhronosGroup/glTF-Sample-Assets
source: https://github.com/KhronosGroup/glTF-Sample-Assets
category: Free 3D Models for Scroll Effects
type: external-resource
github: KhronosGroup/glTF-Sample-Assets
---

# KhronosGroup glTF-Sample-Assets

> Free 3D Models for Scroll Effects · [Open source](https://github.com/KhronosGroup/glTF-Sample-Assets)

This skill provides comprehensive reference for using **KhronosGroup glTF-Sample-Assets** in your projects.
...
|  |  |
|-|-|
| [![Glass Hurricane Candle Holder](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/GlassHurricaneCandleHolder/screenshot/screenshot.jpg)](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/GlassHurricaneCandleHolder/README.md)  | Glass candle holder using Transmission and Volume extensions. [[Show]](https://github.khronos.org/glTF-Sample-Viewer-Release/?model=https://raw.GithubUserContent.com/DRx3D/glTF-Sample-Models/main/Models/GlassHurricaneCandleHolder/glTF-Binary/GlassHurricaneCandleHolder.glb)<br>Credit:<br>&copy; 2021, Wayfair, LLC. [CC BY 4.0 International](https://creativecommons.org/licenses/by/4.0/legalcode)<br> - Eric Chadwick for everything
...
* [Showcase](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-showcase.md) (#showcase) for models that are showcased in Khronos publicity. These are usually complex models with high visual quality.
* [Complete](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models.md) for a complete list of all models.
* [Testing](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-testing.md) (#testing) for models intended to be used for testing of viewers, converts, and other software systems.
* [Core Only](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-core.md) (#core) for models that only use glTF Core V2.0 features and capabilities (no extensions).
* [Video Tutorials](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-video.md) (#video) for models used in any glTF Tutorial video.
* [Written Tutorials](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-written.md) (#written) for models used in a written glTF Tutorial.
* [Issues](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./Models/Models-issues.md) (#issues) for models with one or more issues that need to be resolved.
...
Sample models help the glTF ecosystem, if you are able to contribute a model, see the [contributing section](https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/./SubmittingModels.md).
...
---
*This skill was auto-generated from [KhronosGroup glTF-Sample-Assets](https://github.com/KhronosGroup/glTF-Sample-Assets) — a UI Vault curated resource.*
