---
name: Iconoir
description: UI Vault resource — Icon Sets. https://github.com/iconoir-icons/iconoir
...
> Icon Sets · [Open source](https://github.com/iconoir-icons/iconoir)

This skill provides comprehensive reference for using **Iconoir** in your projects.
...
For more details, see the package [README](https://raw.githubusercontent.com/iconoir-icons/iconoir/main/./packages/iconoir-react).

## React Native

A React Native library is available under the name `iconoir-react-native`.

For more details, see the package [README](https://raw.githubusercontent.com/iconoir-icons/iconoir/main/./packages/iconoir-react-native).

## Vue

A Vue library is available under the name `@iconoir/vue`.

For more details, see the package [README](https://raw.githubusercontent.com/iconoir-icons/iconoir/main/./packages/iconoir-vue).

## Flutter

A Flutter library is available under the name `iconoir_flutter`.

For more details, see the package [README](https://raw.githubusercontent.com/iconoir-icons/iconoir/main/./packages/iconoir-flutter).
...
---
*This skill was auto-generated from [Iconoir](https://github.com/iconoir-icons/iconoir) — a UI Vault curated resource.*
