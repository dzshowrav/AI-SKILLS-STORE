...
|----------|----------|--------|-------------|
| CRITICAL | Test Setup | `setup-` | Kernel bootstrap, base test classes, PHPUnit config |
...
| MEDIUM | Mocking | `mock-` | Service mocking, DI in tests |
| MEDIUM | Data | `data-` | Test data creation, fixtures, cleanup |
| LOW | Performance | `perf-` | Test execution speed, parallel testing |

## How to Use

Read relevant reference files from `references/` directory based on the task.
