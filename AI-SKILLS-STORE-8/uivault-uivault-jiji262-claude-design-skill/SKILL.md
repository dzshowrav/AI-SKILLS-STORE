---
name: jiji262/claude-design-skill
description: UI Vault resource — Claude Skills for Onboarding & UI Design. https://github.com/jiji262/claude-design-skill
source: https://github.com/jiji262/claude-design-skill
category: Claude Skills for Onboarding & UI Design
type: external-resource
github: jiji262/claude-design-skill
---

# jiji262/claude-design-skill

> Claude Skills for Onboarding & UI Design · [Open source](https://github.com/jiji262/claude-design-skill)

This skill provides comprehensive reference for using **jiji262/claude-design-skill** in your projects.
...
- [What it does](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#what-it-does)
- [Skill architecture](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#skill-architecture)
- [Installation](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#installation)
- [Usage](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#usage)
- [When it triggers](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#when-it-triggers)
- [Demos](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#demos)
- [Test prompts](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#test-prompts)
- [Customization](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#customization)
- [License](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/#license)
- [中文 README](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/README.zh.md)
...
Without installation, point Claude at [SKILL.md](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/SKILL.md) directly and ask it to follow the instructions.
...
The skill is designed to be "a little pushy" — it activates on common design phrasings even when the user doesn't say the word "design." See the `description` field in [SKILL.md](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/SKILL.md) for the full trigger list.
...
**[demos/demo-1-deck.html](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/demos/demo-1-deck.html)** — 5-slide pitch deck, Swiss Editorial style (Pentagram / Vignelli lineage). Oversized folios, hairline rules, one accent color. Keyboard navigation, 1-indexed slide labels, localStorage persistence.
...
**[demos/demo-2-canvas.html](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/demos/demo-2-canvas.html)** — 4 hero variations for the same fictional product, drawn from 4 different design schools (Swiss Editorial / Kenya Hara minimalism / Brutalist web / Editorial magazine). Shows the Advisor mode pattern in action.
...
**[demos/demo-3-prototype.html](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/demos/demo-3-prototype.html)** — Interactive 3-screen iOS reading tracker. Click the "+5p / +20p / Finish" buttons on the detail screen and watch state propagate across all three phones live.

See [demos/README.md](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/demos/README.md) for a walkthrough of what to notice in each demo.

## Test prompts

[test-prompts.json](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/test-prompts.json) contains 6 realistic scenario tests, each tagged with the guardrails it exercises:
...
MIT. See [LICENSE](https://raw.githubusercontent.com/jiji262/claude-design-skill/main/LICENSE). The original Claude Design system prompt content is Anthropic's; this repository contains an adapted, restructured rendition intended for use with the Claude Skill specification.
...
---
*This skill was auto-generated from [jiji262/claude-design-skill](https://github.com/jiji262/claude-design-skill) — a UI Vault curated resource.*
