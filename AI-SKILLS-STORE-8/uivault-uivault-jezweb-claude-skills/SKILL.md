...
description: UI Vault resource — Claude Skills for Onboarding & UI Design. https://github.com/jezweb/claude-skills
...
> Claude Skills for Onboarding & UI Design · [Open source](https://github.com/jezweb/claude-skills)

This skill provides comprehensive reference for using **jezweb/claude-skills** in your projects.
...
[![MIT License](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/jezweb/claude-skills/main/LICENSE)
...
See [SKILL_SHAPE.md](https://raw.githubusercontent.com/jezweb/claude-skills/main/SKILL_SHAPE.md) for the authoring shape (frontmatter, sections, what to leave out) and [CLAUDE.md](https://raw.githubusercontent.com/jezweb/claude-skills/main/CLAUDE.md) for repo development conventions.
...
---
*This skill was auto-generated from [jezweb/claude-skills](https://github.com/jezweb/claude-skills) — a UI Vault curated resource.*
